        ...
        <div className='relative container rounded-3xl shadow-lg shadow-black w-[80%] grid md:grid-cols-2 h-fit'>
          <div className='userformimg'>
            ...
            <div className='z-50 relative md:ml-[5%] ml-[10%] md:mt-[40%] p-8'>
              <Heading Write={"WELCOME To Your Favourite Place!"} />
            </div>
          </div>
          <div className='relative px-4 py-4 '>
            ...
            <div className="bg-[#e8e4e400]    w-full max-w-md">
                <h2 className="text-3xl font-serif text-white font-semibold text-center mb-10 "> Change Password</h2>
                <form>
                <div className="mb-4">
                        <label htmlFor="password" className="block text-xl font-medium text-white"> New Password</label>
